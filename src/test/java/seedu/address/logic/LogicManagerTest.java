...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        ...
        assertCommandException(deleteCommand, String.format(MESSAGE_INVALID_PERSON_ID, 9));
    }
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        // Inject LogicManager with an NetConnectStorage that throws the IOException e
        // when saving
        JsonNetConnectStorage netConnectStorage = new JsonNetConnectStorage(prefPath) {
            @Override
            public void saveNetConnect(ReadOnlyNetConnect netConnect, Path filePath)
                    throws IOException {
                throw e;
            }
        };
        ...
        // Execute the command
        String listCommand = ListCommand.COMMAND_WORD;
        assertCommandFailure(listCommand, CommandException.class, expectedMessage, model);
    }
}
